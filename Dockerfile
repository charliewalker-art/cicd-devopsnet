...
# Au runtime, on utilise bien POSTGRES_CONNECTION_STRING (la variable attendue par ton Program.cs)
ENTRYPOINT ["/bin/sh", "-c", "./migrate --connection \"$POSTGRES_CONNECTION_STRING\" && dotnet devopsnet.dll"]